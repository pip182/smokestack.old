...
class CategoryAdmin(ImportExportModelAdmin, SortableAdminMixin):
...
class DepartmentAdmin(ImportExportModelAdmin, SortableAdminMixin):
    list_display = ('order', 'name')
    search_fields = ('name',)


@admin.register(Vendor)
class VendorAdmin(ImportExportModelAdmin, SortableAdminMixin):
    list_display = ('order', 'name', 'address', 'website', 'email')
    search_fields = ('name',)


@admin.register(Item)
class ItemAdmin(ImportExportModelAdmin, SummernoteModelAdmin, SortableAdminMixin):
